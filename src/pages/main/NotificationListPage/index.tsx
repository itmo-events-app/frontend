...
class Notification {
  ...
  constructor(eventName: string, activityName: string, taskName: string, date: string, time: string, text: string, isRead: boolean) {
    this.id = uid();
...
export default function NotificationListPage() {
    ...
    return (
      <div className={styles.notification_entry} key={ne.data.id}>
        ...
        <div className={styles.notification_read}>
          <Button className={ne.data.isRead ? styles.read_button : styles.not_read_button}
  ...
  function _readEntryClick(notificationEntry: NotificationEntry) {
    ...
    setNotifications(notifications.map(e => {
