      ...
      <Dialog className={styles.dialog_content} text={"Редактирование площадки"}>
        <div onClick={e => e.stopPropagation()}>
          <form className={styles.place_form} onSubmit={handleSubmit(onSubmit)}>
            ...
            <iframe id="itmo-map-iframe" src={(window as any).ENV_GEO_URL + "/map.html?noscroll&select_only_areas&show_marker&lat=" + foundPlace?.latitude + "&lon=" + foundPlace?.longitude}
