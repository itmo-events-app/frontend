      ...
      api.event
        ...
        .then((response) => {
          ...
          setActivity({
            ...
            placeId: responseData.placesIds ? responseData.placesIds[0] : -1,
  ...
  return (
    <div>
      ...
      <div className={appendClassName(styles.activity_card_row, styles.activity_card_info)}>
        <div className={appendClassName(styles.activity_initial_row, styles.activity_card_description)}>
        ...
        <div className={additionalInfoVisible ? styles.add_info_visible : styles.add_info_hidden}>
          ...
          <_ActivityModalField
            label={'Максимальный возраст участия'}
          ...
          <_ActivityModalField
            label={'Время завершения регистрации'}
      ...
      {props.canDelete && (
        <div className={appendClassName(styles.activity_card_row, styles.activity_card_footer)}>
          ...
          <Button className={styles.redBtn} onClick={_deleteActivity}>
            Удалить активность
          </Button>
        </div>
      )}
