  ...
  function _navInfo() {
    return (
      <div className={styles.nav_page_nums}>
        <div className={styles.nav_page_num_selected}>{(page - 1) * page_size + 1}</div>
        ...
        <div className={styles.nav_page_num}>{props.items.length}</div>
    ...
    <div className={styles.list_container}>
      <div className={styles.navigator}>
        ...
        <div className={styles.nav_buttons}>
          ...
          <div className={styles.nav_page_num}>{page_size}</div>
