...
const administrator = new PrivilegeContextData(
  new Set([
...
readerEvent.set(1, new Set([new PrivilegeData(PrivilegeNames.VIEW_EVENT_ACTIVITIES)]));
const reader = new PrivilegeContextData(
  new Set([
    new PrivilegeData(PrivilegeNames.MODIFY_PROFILE_DATA),
    new PrivilegeData(PrivilegeNames.VIEW_ALL_EVENTS),
    new PrivilegeData(PrivilegeNames.SEARCH_EVENTS_AND_ACTIVITIES),
...
const organizer = new PrivilegeContextData(
  new Set([
    new PrivilegeData(PrivilegeNames.MODIFY_PROFILE_DATA),
    new PrivilegeData(PrivilegeNames.VIEW_ALL_EVENTS),
    new PrivilegeData(PrivilegeNames.SEARCH_EVENTS_AND_ACTIVITIES),
...
const helper = new PrivilegeContextData(
  new Set([
    new PrivilegeData(PrivilegeNames.MODIFY_PROFILE_DATA),
    new PrivilegeData(PrivilegeNames.VIEW_ALL_EVENTS),
    new PrivilegeData(PrivilegeNames.SEARCH_EVENTS_AND_ACTIVITIES),
