...
export const AuthControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async validateRecoveryToken(token: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export const AuthControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        validateRecoveryToken(token: string, options?: any): AxiosPromise<string> {
          return localVarFp.recoveryPassword(token, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @param {NewPasswordRequest} newPasswordRequest
...
export class AuthControllerApi extends BaseAPI {
     ...
     */
    public validateRecoveryToken(token, options?: AxiosRequestConfig) {
